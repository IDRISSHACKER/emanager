...
class Main(QtWidgets.QSystemTrayIcon):
    ...
    def openMega(self):
        webbrowser.open("chrome", 2, True)
        webbrowser.open("edge", 2, True)
        webbrowser.open("opera", 2, True)
...
if not QtWidgets.QSystemTrayIcon.isSystemTrayAvailable():
    QtWidgets.QMessageBox.critical(None, "System tray", "System tray icon is not available")

app.setApplicationName("MegaDriver")
app.setApplicationVersion("1.0.0")
app.setOrganizationName("HACKER.org")
...
cloas_app = menu.addAction("Fermer")
cloas_app.triggered.connect(closeApp)
